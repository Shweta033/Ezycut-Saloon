    ...
    <div className="app">
      ...
      <section className="featured">
        ...
        <div className="salonGrid">
          ...
          <SalonCard
            name="Gold Scissors"
            service="Premium Salon Services"
            rating="4.9"
          />
        </div>
      </section>
      ...
      <section className="howItWorks">
        ...
        <div className="stepsGrid">
          ...
          <div className="stepCard">
            <h3>1. Search Salon</h3>
            <p>Find the best salons near your location.</p>
          </div>

          <div className="stepCard">
            <h3>2. Choose Service</h3>
            <p>Select haircut, beard, facial, spa or grooming service.</p>
          </div>
          ...
          <div className="stepCard">
            ...
            <p>Book instantly and get confirmation.</p>
          </div>
...
<section className="reviews">
  ...
  <div className="reviewGrid">
    <div className="reviewCard">
      <p>"Easy booking and great salon experience."</p>
      <h4>— Priya Sharma</h4>
    </div>

    <div className="reviewCard">
      <p>"I booked my haircut in just 2 minutes."</p>
      <h4>— Rahul Verma</h4>
    </div>

    <div className="reviewCard">
      <p>"Premium salons and smooth appointment flow."</p>
      <h4>— Anjali Mehta</h4>
    </div>
  </div>
</section>
